...
button { background: none; border: none; color: #fff; cursor: pointer; font-size: 14px;}
input {background: #fff; border: none; font-size: 14px;}
...
.block, .login span, .password span {display: block;}
.pointer { cursor: pointer;}

header { width: 100%; height: 42px; background: #1a1a1a; }
#head { width: 1600px; }
#logo { width: 300px; margin: 8px 10px;}
#logo a { font-size: 18px!important; }
#access {  height: 42px; margin-right: 10px; }
#profile { margin-right: 50px;}
#profilenav { height: 42px; line-height: 42px; width: 100px; }
.avatar { position: absolute; border: 1px solid #fff; border-radius: 20px; width: 26px; height: 26px; margin: 8px 0 0 -20px;}
.avatar img { width: 12px; margin: 7px 0 0 7px;}
#search { display: inline-block; width: 42px; height: 24px;}
.search { height: 20px; background: #c0c0c0; width: 180px; margin-left: 10px; padding-left: 5px;}
